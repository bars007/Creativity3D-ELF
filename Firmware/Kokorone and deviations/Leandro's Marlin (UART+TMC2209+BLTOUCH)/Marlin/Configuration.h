...
#define STRING_CONFIG_H_AUTHOR "(Leandro, ELF BL-Touch Scaled by Kokorone)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Leo's ELF"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // ELF stock
  #define DEFAULT_bedKp 38.56
  #define DEFAULT_bedKi 7.29
  #define DEFAULT_bedKd 136.02
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 441.30 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -20, -4 }
